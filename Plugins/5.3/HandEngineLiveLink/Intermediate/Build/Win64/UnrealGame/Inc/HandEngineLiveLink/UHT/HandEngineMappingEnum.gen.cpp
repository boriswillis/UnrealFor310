...
#include "HandEngineLiveLink/Public/HandEngineMappingEnum.h"
...
// End Cross Module References
	...
	static UEnum* EHandEngineMapping_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EHandEngineMapping.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HandEngineLiveLink_EHandEngineMapping, Z_Construct_UPackage__Script_HandEngineLiveLink(), TEXT("EHandEngineMapping"));
		}
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_HandEngineLiveLink_EHandEngineMapping_Statics::Enum_MetaDataParams[] = {
		...
		{ "Ring_00_l.DisplayName", "ring_01_l" },
		{ "Ring_00_l.Name", "EHandEngineMapping::Ring_00_l" },
		{ "Ring_00_r.DisplayName", "ring_01_r" },
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_HandEngineLiveLink_EHandEngineMapping_Statics::EnumParams = {
		...
		METADATA_PARAMS(Z_Construct_UEnum_HandEngineLiveLink_EHandEngineMapping_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_HandEngineLiveLink_EHandEngineMapping_Statics::Enum_MetaDataParams))
	};
	...
	static UEnum* EHandEngineRetargetNamingConvention_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EHandEngineRetargetNamingConvention.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HandEngineLiveLink_EHandEngineRetargetNamingConvention, Z_Construct_UPackage__Script_HandEngineLiveLink(), TEXT("EHandEngineRetargetNamingConvention"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_HandEngineLiveLink_EHandEngineRetargetNamingConvention_Statics::EnumParams = {
		...
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_HandEngineLiveLink_EHandEngineRetargetNamingConvention_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_HandEngineLiveLink_EHandEngineRetargetNamingConvention_Statics::Enum_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_JorenThiessen_Documents_GitHub_stretchsense_studio_plugin_unreal_Plugins_HandEngineLiveLink_Source_HandEngineLiveLink_Public_HandEngineMappingEnum_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_JorenThiessen_Documents_GitHub_stretchsense_studio_plugin_unreal_Plugins_HandEngineLiveLink_Source_HandEngineLiveLink_Public_HandEngineMappingEnum_h_Statics::EnumInfo[] = {
		{ EHandEngineMapping_StaticEnum, TEXT("EHandEngineMapping"), &Z_Registration_Info_UEnum_EHandEngineMapping, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1020902066U) },
		{ EHandEngineRetargetNamingConvention_StaticEnum, TEXT("EHandEngineRetargetNamingConvention"), &Z_Registration_Info_UEnum_EHandEngineRetargetNamingConvention, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3656832093U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_JorenThiessen_Documents_GitHub_stretchsense_studio_plugin_unreal_Plugins_HandEngineLiveLink_Source_HandEngineLiveLink_Public_HandEngineMappingEnum_h_707091741(TEXT("/Script/HandEngineLiveLink"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_JorenThiessen_Documents_GitHub_stretchsense_studio_plugin_unreal_Plugins_HandEngineLiveLink_Source_HandEngineLiveLink_Public_HandEngineMappingEnum_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_JorenThiessen_Documents_GitHub_stretchsense_studio_plugin_unreal_Plugins_HandEngineLiveLink_Source_HandEngineLiveLink_Public_HandEngineMappingEnum_h_Statics::EnumInfo));
