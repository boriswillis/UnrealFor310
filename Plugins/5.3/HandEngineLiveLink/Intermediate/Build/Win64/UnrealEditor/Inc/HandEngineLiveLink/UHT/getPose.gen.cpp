...
#include "../../Source/HandEngineLiveLink/Public/getPose.h"
...
// End Cross Module References
	...
	static UEnum* ExecOutputs_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ExecOutputs.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HandEngineLiveLink_ExecOutputs, (UObject*)Z_Construct_UPackage__Script_HandEngineLiveLink(), TEXT("ExecOutputs"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_HandEngineLiveLink_ExecOutputs_Statics::EnumParams = {
		...
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_HandEngineLiveLink_ExecOutputs_Statics::Enum_MetaDataParams), Z_Construct_UEnum_HandEngineLiveLink_ExecOutputs_Statics::Enum_MetaDataParams)
	};
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UgetPose_getPose_Statics::NewProp_DataResult = { "DataResult", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(getPose_eventgetPose_Parms, DataResult), Z_Construct_UScriptStruct_FSubjectFrameHandle, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UgetPose_getPose_Statics::NewProp_DataResult_MetaData), Z_Construct_UFunction_UgetPose_getPose_Statics::NewProp_DataResult_MetaData) }; // 271589841
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UgetPose_getPose_Statics::NewProp_PoseName_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UgetPose_getPose_Statics::NewProp_PoseName = { "PoseName", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(getPose_eventgetPose_Parms, PoseName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UgetPose_getPose_Statics::NewProp_PoseName_MetaData), Z_Construct_UFunction_UgetPose_getPose_Statics::NewProp_PoseName_MetaData) };
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UgetPose_getPose_Statics::NewProp_Branches = { "Branches", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(getPose_eventgetPose_Parms, Branches), Z_Construct_UEnum_HandEngineLiveLink_ExecOutputs, METADATA_PARAMS(0, nullptr) }; // 2294651090
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UgetPose_getPose_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UgetPose, nullptr, "getPose", nullptr, nullptr, Z_Construct_UFunction_UgetPose_getPose_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UgetPose_getPose_Statics::PropPointers), sizeof(Z_Construct_UFunction_UgetPose_getPose_Statics::getPose_eventgetPose_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UgetPose_getPose_Statics::Function_MetaDataParams), Z_Construct_UFunction_UgetPose_getPose_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UgetPose_getPose_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_UgetPose_getPose_Statics::getPose_eventgetPose_Parms) < MAX_uint16);
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UgetPose_Statics::DependentSingletons) < 16);
	const FClassFunctionLinkInfo Z_Construct_UClass_UgetPose_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UgetPose_getPose, "getPose" }, // 1054799847
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UgetPose_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UgetPose_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UgetPose_Statics::Class_MetaDataParams), Z_Construct_UClass_UgetPose_Statics::Class_MetaDataParams)
	};
	...
	UgetPose::UgetPose(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UgetPose);
	UgetPose::~UgetPose() {}
	struct Z_CompiledInDeferFile_FID_Users_JorenThiessen_Documents_Unreal_Projects_PluginUpgrade5_3_Plugins_HandEngineLiveLink_Source_HandEngineLiveLink_Public_getPose_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_JorenThiessen_Documents_Unreal_Projects_PluginUpgrade5_3_Plugins_HandEngineLiveLink_Source_HandEngineLiveLink_Public_getPose_h_Statics::EnumInfo[] = {
		{ ExecOutputs_StaticEnum, TEXT("ExecOutputs"), &Z_Registration_Info_UEnum_ExecOutputs, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2294651090U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_JorenThiessen_Documents_Unreal_Projects_PluginUpgrade5_3_Plugins_HandEngineLiveLink_Source_HandEngineLiveLink_Public_getPose_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UgetPose, UgetPose::StaticClass, TEXT("UgetPose"), &Z_Registration_Info_UClass_UgetPose, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UgetPose), 3807950118U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_JorenThiessen_Documents_Unreal_Projects_PluginUpgrade5_3_Plugins_HandEngineLiveLink_Source_HandEngineLiveLink_Public_getPose_h_3836246722(TEXT("/Script/HandEngineLiveLink"),
		Z_CompiledInDeferFile_FID_Users_JorenThiessen_Documents_Unreal_Projects_PluginUpgrade5_3_Plugins_HandEngineLiveLink_Source_HandEngineLiveLink_Public_getPose_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_JorenThiessen_Documents_Unreal_Projects_PluginUpgrade5_3_Plugins_HandEngineLiveLink_Source_HandEngineLiveLink_Public_getPose_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_JorenThiessen_Documents_Unreal_Projects_PluginUpgrade5_3_Plugins_HandEngineLiveLink_Source_HandEngineLiveLink_Public_getPose_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_JorenThiessen_Documents_Unreal_Projects_PluginUpgrade5_3_Plugins_HandEngineLiveLink_Source_HandEngineLiveLink_Public_getPose_h_Statics::EnumInfo));
