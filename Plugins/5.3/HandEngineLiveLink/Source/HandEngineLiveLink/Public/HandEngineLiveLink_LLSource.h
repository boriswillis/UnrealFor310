...
class HANDENGINELIVELINK_API FHandEngineLiveLink_LLSource : public ILiveLinkSource, public FRunnable
{
public:

	FHandEngineLiveLink_LLSource(FIPv4Endpoint Endpoint);

	virtual ~FHandEngineLiveLink_LLSource();
