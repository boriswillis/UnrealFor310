...
#include "HandEngineLiveLink_LLSourceFactory.generated.h"

class SHandEngineLiveLink_LLSourceEditor;

UCLASS()
class UHandEngineLiveLink_LLSourceFactory : public ULiveLinkSourceFactory
{
public:
